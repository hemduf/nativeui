...
set(_header_fixture "${SOURCE_DIR}/tests/headers/dispatcher.cpp")
...
if(NOT EXISTS "${_header_fixture}")
  message(FATAL_ERROR "T065 root integration contract: missing dispatcher public-header fixture: ${_header_fixture}")
endif()
