...
post-1.0 / later-release work already landed:
  ...
  T073(done) + T079(done) -> T088(done) -> T089(ready) -> T090(blocked) -> T091(blocked) -> T092(blocked on T089-T091)
  T098(done) ---------------------------------------------------------------> T086(done)
  T068 ----------------------------------------------> 1.2
```
