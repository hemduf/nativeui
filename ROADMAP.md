...
post-1.0 / later-release work already landed:
  ...
  T073(done) + T079(done) -> T088(done) -> T089(done) -> T090(ready) -> T091(blocked) -> T092(blocked on T090-T091)
  T098(done) ---------------------------------------------------------------> T086(done)
  T068 ----------------------------------------------> 1.2
```
