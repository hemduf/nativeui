...
if(NOT NATIVEUI_SKIA_ROOT)
  ...
  if(APPLE)
    ...
    set(_skia_hash "SHA256=5fff34ca61589d0ebd3ebcddf81e56b9ae73c68d7b012ed58f36e0846f94a133")
  elseif(WIN32)
    string(TOUPPER "${NATIVEUI_SKIA_WINDOWS_CRT}" _crt)
    if(_crt STREQUAL "MD")
      set(_suffix "gpu-md")
      if(NATIVEUI_SKIA_CONFIG STREQUAL "Debug")
        set(_skia_hash "SHA256=28a0f107e150d8a19ec263d6851f7b3c35d500798abed5db456a2f81a2e24e7d")
      else()
        set(_skia_hash "SHA256=dbbd5bd48f917c923dbcf431d969eb5974df3c813dfd435f959ce2e09e4ef7af")
      endif()
    elseif(_crt STREQUAL "MT")
      set(_suffix "gpu")
      if(NATIVEUI_SKIA_CONFIG STREQUAL "Debug")
        set(_skia_hash "SHA256=063b0edf400c49c4ef9dd04a54b10d228a40cf54e414ebc5869c04b6045cf14e")
      else()
        set(_skia_hash "SHA256=29060f37e15c51f10bb8daab51250a913ca30b6fbd6d3ae7b382c16e2cc83b6a")
      endif()
    else()
  ...
  elseif(UNIX)
    ...
    set(_skia_hash "SHA256=ecc742329e989ddb0c6404ae9d54be860f5a765b10723352c38493b86692f99f")
  endif()
