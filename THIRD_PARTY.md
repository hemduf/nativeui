...
- **Skia** — binary static libraries from `hemduf/skia-builder`, release `chrome/m149`. The builder fork retains the MIT-licensed upstream `olilarkin/skia-builder` codebase; Skia itself uses its upstream BSD-style license and bundled third-party licenses.
